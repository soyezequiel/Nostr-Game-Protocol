...
- **El escrow NGE es custodial.** La tienda custodia el pozo mientras la apuesta corre. El diseño acota el daño (un `secret` filtrado puede elegir ganador entre los asientos declarados, no redirigir fondos; toda acción del escrow puede quedar anclada como evento firmado y verificable), pero custodial es custodial — el protocolo no lo esconde.
