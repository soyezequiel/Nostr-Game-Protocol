// NGE v2 — CLIENTE (la "NWC del escrow", lado juego).
//
// Ergonomía sobre el núcleo de protocolo (`nge-core.ts`): el juego (cliente `C`,
// el `secret` de la URI) le habla al escrow (`S`, el host de la URI) por el RPC
// request/response calcado de NWC/NIP-47. El relay es un caño tonto; la fuente de
...
// Spec: docs/nge/nge-v2-spec.md (repo de Luna Negra).
//
