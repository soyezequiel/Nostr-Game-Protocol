...
| --- | --- |
| [ngp.md](ngp.md) | **NGP** — la capa pública: identidad, coordenada del juego, marcador (`kind:31339`), atestación de oráculo (`kind:31338`), presencia (NIP-38), reto 1v1 (NIP-17) |
...
> 31339** y los lectores aceptan ambos (`NGP_SCORE_READ_KINDS` en el core);
> cuando se cierre la doble lectura, 31337 deja de leerse. Detalle y plan:
> [../nip/roadmap.md](../nip/roadmap.md).
...
| **N1 — Marcador** | Evento de score 31339 (+ atestación 31338 opcional) | [ngp §2–3](ngp.md) |
...
- **2026-07** — **score renumerado 31337 → 31339** (colisión con "Audio Track" de facto). Escritura solo en 31339; doble lectura 31339+31337 durante la transición.
